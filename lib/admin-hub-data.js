...
import { createCustomerEvent, findOrCreateCustomer, recordInquiry, updateCustomerNote as updateDatabaseCustomerNote } from './customer-identity.js';
...
async function loadAirtableCustomerDetail(customerId) {
  ...
  return {
    customer: { ...customer, owner_note: ownerNote, contact_status: contactStatus, next_follow_up_at: nextFollowUp, fallback_source: 'airtable_forms' },
    inquiries,
    reservations: [],
    payments: [],
    payment_methods: [],
