...
async function loadCustomerDetail(customerId) {
  ...
  return withTimeline({ customer, inquiries, reservations, payments, payment_methods: methods, communications, internal_notes: internalNotes, events });
}
...
async function updateCustomerProfile({ customerId, fullName = '', email = '', phone = '', status = 'lead', tags = [] }) {
  ...
  await createCustomerEvent({
    ...
    metadata: { status: cleanStatus, tags: cleanTags },
    occurredAt: now
  });
