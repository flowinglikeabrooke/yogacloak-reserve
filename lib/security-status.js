...
function loadSecurityStatus() {
  return {
    ...
    durable_rate_limit_configured: (configured('KV_REST_API_URL') && configured('KV_REST_API_TOKEN')) || (configured('UPSTASH_REDIS_REST_URL') && configured('UPSTASH_REDIS_REST_TOKEN')),
