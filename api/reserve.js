...
export default async function handler(req, res) {
    ...
    // Support both field name conventions from the frontend
    ...
    // Support both "product" (string) and "products" (array) from the frontend
    let product;
    ...
    try {
                const session = await stripe.checkout.sessions.create({
                                ...
                                cancel_url: siteUrl + "/yogacloak-reserve-page.html?product=" + (product === "both" ? "cloak" : product),
